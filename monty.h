...
void print_error_message(char *message, char *file);
void add_new_stack_beg(stack_t **stack, unsigned int);
void add_new_stack_end(stack_t **stack, unsigned int);
void tokenizer(char *cmd, ssize_t read);
void (*get_dispatch_function(char *str))(stack_t**, unsigned int);
void malloc_error(void);
void pop_function(stack_t **stack, unsigned int);
void print_int(stack_t **stack, unsigned int line_number);
void print_all(stack_t **stack, unsigned int line_number);
void nop(stack_t **stack, unsigned int line_number);
void print_add(stack_t **stack, unsigned int line_number);
void divide_function(stack_t **stack, unsigned int);
...
void paste_string_function(stack_t **stack, unsigned int line_number);
void rotate_stack_function(stack_t **stack, unsigned int line_number);
...
int  is_digit(char *c);
void pall_stack_function(stack_t **stack, unsigned int line_number);
void swap(stack_t **stack, unsigned int line_number);
void sub(stack_t **stack, unsigned int);
void multiplication_function(stack_t **stack, unsigned int);
